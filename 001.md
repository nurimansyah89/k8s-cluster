...
Lalu, cari `CALICO_IPV4POOL_CIDR`, hapus komentar dan ubah `value`-nya menjadi `10.10.0.0/16` (Sesuai dengan `--pod-network-cird` saat inisiasi control plane diatas)
![](./assets/003.png)
...
Agar calico bisa menjalankan schedule di control plane:
```bash
